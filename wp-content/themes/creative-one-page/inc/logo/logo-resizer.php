...
function creative_one_page_logo_customize_register( $wp_customize ) {
	...
	// logo padding
	$wp_customize->add_setting( 'creative_one_page_logo_padding_top',array(
		'default' => 0,
		'sanitize_callback'	=> 'creative_one_page_sanitize_float',
	));
	$wp_customize->add_control( 'creative_one_page_logo_padding_top',	array(
		'label' => esc_html__( 'Top Bottom Logo Padding','creative-one-page' ),
		'section' => 'title_tagline',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting( 'creative_one_page_logo_padding_left',array(
		'default' => 0,
		'sanitize_callback'	=> 'creative_one_page_sanitize_float',
	));
	$wp_customize->add_control( 'creative_one_page_logo_padding_left',	array(
		'label' => esc_html__( 'Right Left Logo Padding','creative-one-page' ),
		'section' => 'title_tagline',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	// logo margin
	$wp_customize->add_setting( 'creative_one_page_logo_margin_top',array(
		'default' => 0,
		'sanitize_callback'	=> 'creative_one_page_sanitize_float',
	));
	$wp_customize->add_control( 'creative_one_page_logo_margin_top',	array(
		'label' => esc_html__( 'Top Bottom Logo Margin','creative-one-page' ),
		'section' => 'title_tagline',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting( 'creative_one_page_logo_margin_left',array(
		'default' => 0,
		'sanitize_callback'	=> 'creative_one_page_sanitize_float',
	));
	$wp_customize->add_control( 'creative_one_page_logo_margin_left',	array(
		'label' => esc_html__( 'Right Left Logo Margin','creative-one-page' ),
		'section' => 'title_tagline',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
   ...
   $wp_customize->add_setting('creative_one_page_site_title_size_option',array(
	...
	$wp_customize->add_setting('creative_one_page_site_title_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'creative_one_page_site_title_color', array(
		'label'    => __('Site Title Color', 'creative-one-page'),
		'section'  => 'title_tagline',
		'settings' => 'creative_one_page_site_title_color',
	)));
   ...
   $wp_customize->add_setting('creative_one_page_site_tagline_size_option',array(
	...
	$wp_customize->add_setting('creative_one_page_site_tagline_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'creative_one_page_site_tagline_color', array(
		'label'    => __('Site Tagline Color', 'creative-one-page'),
		'section'  => 'title_tagline',
		'settings' => 'creative_one_page_site_tagline_color',
	)));
}
